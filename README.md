...
> **Note:** The frontend remains publicly available, but backend features may be temporarily unavailable because AWS compute and database services are paused when not in use to reduce hosting costs. Screenshots and architecture details below demonstrate the full deployed application and system design.
